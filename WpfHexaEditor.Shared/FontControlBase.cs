...
namespace WpfHexaEditor
{
    public abstract class FontControlBase : FrameworkElement, IFontControl {
        ...
        protected virtual void OnFontSizeChanged(double oldFontSize, double newFontSize) => OnUpdateSizes();
        ...
        protected virtual void OnFontWeightChanged(FontWeight oldFontWeight, FontWeight newFontWeight) => OnUpdateSizes();
...
#endif
        protected Typeface TypeFace => _typeface ?? (_typeface = new Typeface(FontFamily, new FontStyle(), FontWeight, new FontStretch()));
